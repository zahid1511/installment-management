...
class GuarantorsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($customers as $customer) {
            // First guarantor (Primary)
            Guarantor::create([
                'customer_id' => $customer->id,
                'name' => 'Khurram Shahzad',
                'father_name' => 'Shahzad Ali',
                'relation' => 'Friend',
                'nic' => '35404-1234567-' . $customer->id, // Make NIC unique per customer
                'phone' => '03023337137',
                ...
                'guarantor_no' => 1,
                'image' => null, // No default image - will be uploaded later
            ]);

            // Second guarantor (Secondary)
            Guarantor::create([
                'customer_id' => $customer->id,
                'name' => 'Waqas Naseer',
                'father_name' => 'Naseer ul din anjum',
                'relation' => 'Friend',
                'nic' => '35404-2345678-' . $customer->id, // Make NIC unique per customer
                'phone' => '03234744067',
